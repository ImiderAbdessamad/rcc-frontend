...
export const GROUPS = [
  ...
  },
  {
    key: "D",
    letter: "D",
    title: "Indicateurs extraits et dérivés",
    subtitle: "Valeur ajoutée, EBE, CAF et équilibres financiers",
    codes: [
      "VALEUR_AJOUTEE",
      "EBE",
      "CAF",
...
export const FORMULAS = {
  ...
  STOCKS: "Stocks de marchandises, matières et produits finis",
  FONDS_PROPRES: "Capitaux propres de l'entreprise",
  RESULTAT_EXPLOITATION: "Résultat d'exploitation de l'exercice",
  DOTATIONS_EXPLOITATION: "Dotations aux amortissements et provisions d'exploitation",
  VALEUR_AJOUTEE: "Valeur ajoutée extraite de l'ESG",
  EBE: "Excédent brut d'exploitation",
  CAF: "Capacité d'autofinancement",
  TRESORERIE_NETTE: "Trésorerie actif − trésorerie passif",
  FDR: "Fonds de roulement",
  BFR: "Besoin en fonds de roulement",
  DETTES_FINANCIERES: "Dettes bancaires MLT + CT",
  ENDETTEMENT_TERME: "Endettement à terme",
};
